...
export function StateWorkspace() {
  ...
  return (
    <WorkspaceLayout roleTitle="State Nodal Authority" navItems={navItems}>
      {/* Header */}
      ...
      <Card title="District-wise Implementation Breakdown" subtitle="Distribution of projects across state districts">
        {loading ? (
